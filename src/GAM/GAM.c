...
ACP_tdxBool(*PLA_fn_bDoAnimPlayerForCharacter)(HIE_tdstSuperObject* p_stSuperObject, ACP_tdxBool bNoDisplay, ACP_tdxBool _bHandleSkippedEventsIfRelevant) = OFFSET(0x40e9e0);
