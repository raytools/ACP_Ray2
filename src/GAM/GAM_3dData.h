...
ACP_FUNC ACP_tdxBool(*PLA_fn_bDoAnimPlayerForCharacter)(HIE_tdstSuperObject *p_stSuperObject, ACP_tdxBool bNoDisplay, ACP_tdxBool _bHandleSkippedEventsIfRelevant);
ACP_FUNC ACP_tdxBool(*GAM_fn_b3dDataCanComputeBrain)(HIE_tdstSuperObject *p_stSuperObject);